...
var _renderPets = require("./js/renderPets");
var _addPets = require("./js/addPets");
var _removePost = require("./js/removePost");
var _edutTweet = require("./js/edutTweet");
var _logReg = require("./js/logReg");
var _toments = require("./js/toments");

},{"./js/renderPets":"9Z7El","./js/addPets":"9WsxZ","./js/removePost":"e9MfP","./js/edutTweet":"kQTyV","./js/logReg":"5N8CN","./js/toments":"8YJdR"}],"9Z7El":[function(require,module,exports) {
    ...
    try {
        ...
        <div class="photo-card">
          <div class="photo-card2">
            <div class="stats">
              <p class="stats-item">
                \u{456}\u{43C}\u{44F} \u{442}\u{432}\u{430}\u{440}\u{438}\u{43D}\u{43A}\u{438}:<br />   
                ${data.namePets}   
              </p>
              <p class="stats-item">
                \u{432}\u{43B}\u{430}\u{441}\u{43D}\u{438}\u{43A} \u{442}\u{432}\u{430}\u{440}\u{438}\u{43D}\u{43A}\u{438}:<br />  
                ${data.owner} 
              </p>
              <p class="stats-item">
                \u{43E}\u{43F}\u{438}\u{441} \u{442}\u{432}\u{430}\u{440}\u{438}\u{43D}\u{43A}\u{438}:<br />
                ${data.director} 
              </p>
              <p class="stats-item">
                \u{434}\u{43E}\u{43C}\u{430}\u{448}\u{43D}\u{44C}\u{43E}\u{43C}\u{443} \u{443}\u{43B}\u{44E}\u{431}\u{43B}\u{435}\u{43D}\u{446}\u{44E}:<br />
                ${2024 - data.year} \u{440}\u{43E}\u{43A}\u{456}\u{432}
              </p>
            </div>
          </div>
          <p class="stats-item">
...
},{}],"9WsxZ":[function(require,module,exports) {
...
},{}],"e9MfP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "removeTweet", ()=>removeTweet);
...
},{}],"kQTyV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "edit2", ()=>edit2);
...
btnEdOpenModal2ed.addEventListener("click", ()=>{
    if (inputed.value == 0) alert("\u0412\u0438 \u043F\u043E\u0432\u0438\u043D\u043D\u0456 \u0432\u0432\u0435\u0441\u0442\u0438 ID \u043F\u043E\u0441\u0442\u0430 \u0456\u043D\u0430\u043A\u0448\u043A\u0435 \u043C\u0438 \u043D\u0435 \u0437\u043C\u043E\u0436\u0435\u043C\u043E \u0432\u0430\u043C \u0434\u043E\u043F\u043E\u043C\u043E\u0433\u0442\u0438");
    else {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5N8CN":[function(require,module,exports) {
...
btnLog.addEventListener("click", ()=>{
    ...
    if (namelog == 0 || passlog == 0) alert("\u0412\u0432\u0435\u0434\u0456\u0442\u044C \u043A\u043E\u043A\u0442\u043D\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u043D\u044F");
    else {
...
async function getName() {
    ...
    if (namereg == null) {
        ...
        console.log(123);
    } else gost.textContent = localStorage.getItem("login");
}
getName();
...
},{}],"8YJdR":[function(require,module,exports) {
const btnOpenmodal = document.querySelector(".button-addopen-modal");
...
sentComent.onclick = function() {
    ...
    if (commentBodyy.value == 0 || commentNamee.value == 0) alert("\u0417\u0430\u043F\u043E\u0432\u043D\u0456\u0442\u044C \u0432\u0441\u0456 \u043F\u043E\u043B\u044F");
    else {
        modalComent.classList.add("true");
...
function showComments() {
    ...
    comments.forEach(function(item) {
        ...
        <p class="text-right small ff"><em>\u{406}\u{43C}'\u{44F}</em></p>
        <p class="alert alert-primary ff" role="alert">${item.name}</p>
        <p class="text-right small ff"><em>\u{41A}\u{43E}\u{43C}\u{435}\u{43D}\u{442}\u{430}\u{440}</em></p>
...
},{}]},["cUXhu","8lqZg"], "8lqZg", "parcelRequireb1a9")
